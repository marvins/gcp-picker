...
#
"""
Configuration management for Auto-GCP Solver.
"""
...
@dataclass
class Configuration:
    """Complete configuration for Auto-GCP Solver.
    ...
    Attributes:
        ...
        auto_match: Auto-match pipeline settings (ALGO1 only).
    """
    ...
    def parse_command_line() -> argparse.Namespace:
        ...
        parser = argparse.ArgumentParser(
            description='Auto-GCP Solver - Computer Vision-based GCP creation tool'
        )
        parser.add_argument(
            '-c', '--config-file',
            type=str,
    ...
    def create_config(pathname: str) -> None:
        ...
        with open(pathname, 'w') as f:
            ...
            f.write("#\n")
            f.write("# Auto-GCP Solver Configuration\n")
            f.write("# Generated by pointy-auto-gcp-solver -g\n")
            f.write("\n")
            ...
            f.write("\n")
            f.write("# Auto-match algorithm settings (ALGO1: Keypoint-based matching)\n")
            f.write("[auto_match]\n")
            f.write("keypoint_algo = \"AKAZE\"\n")
            f.write("\n")
    ...
    def parse(cls) -> Configuration:
        ...
        # Parse keypoint algorithm
        keypoint_algo_str = auto_match_data.get('keypoint_algo', 'akaze').lower()
        keypoint_algo = Match_Algo(keypoint_algo_str)

        # Parse test extraction settings
        test_ext_data = auto_match_data.get('test_extraction', {})
        ...
        test_extraction = Feature_Extraction_Settings(
            ...
            pyramid_level=test_ext_data.get('pyramid_level', 0),
            clahe=test_ext_data.get('clahe', True),
            akaze=test_akaze,
            orb=test_orb,
        )

        ref_ext_data = auto_match_data.get('ref_extraction', {})
        ...
        match_data = auto_match_data.get('matching', {})
        ...
        outlier_data = auto_match_data.get('outlier', {})
