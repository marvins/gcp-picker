...
class Tools_Panel(QWidget):
    ...
    def update_fit_results(self, rmse: float | None, residuals: list[GCP_Residual]):
        ...
        for residual in residuals:
            ...
            self.residuals_table.setItem(row, 1, QTableWidgetItem(f"{residual.geographic.latitude_deg:.6f}"))
            self.residuals_table.setItem(row, 2, QTableWidgetItem(f"{residual.geographic.longitude_deg:.6f}"))
